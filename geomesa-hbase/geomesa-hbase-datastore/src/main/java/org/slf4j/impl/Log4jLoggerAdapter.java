...
/*
  ...
  resulted in a NoClassDefFoundError during unit tests with the HBase mini cluster. HBase doesn't
  do anything meaningful with the class, so this placeholder was added to resolve those errors.
 */
